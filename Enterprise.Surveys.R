...
table(es2$obst1); table(es2$obst2); table(es2$obst3); table(es2$obst4)
table(es2$obst5); table(es2$obst6); table(es2$obst7); table(es2$obst8)
table(es2$obst9); table(es2$obst10); table(es2$obst11)
table(es2$obst12); table(es2$obst13); table(es2$obst14); table(es2$obst15)
